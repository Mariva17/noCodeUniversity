...
public class AddCourseTest extends BaseTest {
    ...
    public void successfulCourseAddition() {
        ...
        addCoursePage.enterCourseName("Course-QA");
        addCoursePage.enterFacultySciences();
        addCoursePage.checkFacultyName("Sciences");
        ...
        profileOfTeacherPage.checkNameOfCourse("New Course-2");
    }
    @Test
